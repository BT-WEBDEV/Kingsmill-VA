...
class GKA_Theme_Events_Widget extends SiteOrigin_Widget {

    function __construct() {

		parent::__construct(
			'gka-theme-events',
			__('(GKA)+ Events', 'gka-theme-widgets'),
			array(
		...
		add_filter( 'siteorigin_widgets_sanitize_instance_gka-theme-events', array( $this, 'add_noreferrer_to_link_targets' ) );
    }
    ...
    function get_widget_form() {
        ...
        $categories = wp_list_pluck( get_terms( 'tribe_events_cat', array('orderby' => 'term_id', 'order'   => 'ASC') ), 'name', 'term_id' );
...
siteorigin_widget_register( 'gka-theme-events', __FILE__, 'GKA_Theme_Events_Widget' );