<?php
/**
 * Template Name: Memberpress Account
 *
 * Description: Memberpress Account
 *
 * @package WordPress
 * @subpackage REDI
 * @since REDI 1.0
...
<div id="primary" class="content-area nav-space">
	<main id="main" class="site-main">
		...
		<section class="main-section memberpress-account-section">
			<div class="container memberpress-account-container">
