...
/**
 * Hide Widget delete link
 */
// add_action('admin_head', 'hide_widget_delete_link');

// function hide_widget_delete_link() {
//   echo '<style>
//     .widget-control-actions .widget-control-remove {
//       display: none;
//     } 
// 	.inactive-sidebar .widget-control-actions .widget-control-remove {
...
function wpf_dev_process_complete( $fields, $entry, $form_data, $entry_id ) {
	if ( absint( $entry['id'] ) == 1364 ) {
		
		$firstName = $entry['fields']['3'];
		$lastName = $entry['fields']['4'];
		$email = $entry['fields']['1'];
		$phone = $entry['fields']['6'];
		$comment = $entry['fields']['2'];

		require(get_template_directory() . '/salesForceAPI/salesForceContactFeed.php');
