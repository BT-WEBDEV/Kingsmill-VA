...
<div class="mp_wrapper">
    ...
    <form class="mepr-account-form mepr-form" id="mepr_account_form" action="" method="post"
        ...
        <div class="mp-form-row mepr_first_name">
            <div class="mp-form-label">
                <label
                    for="user_first_name"><?php _ex('First Name:', 'ui', 'memberpress'); echo ($mepr_options->require_fname_lname)?'*':''; ?></label>
        ...
        <div class="mp-form-row mepr_last_name">
            <div class="mp-form-label">
                <label
                    for="user_last_name"><?php _ex('Last Name:', 'ui', 'memberpress'); echo ($mepr_options->require_fname_lname)?'*':''; ?></label>
        ...
        <div class="mp-form-row">
            <div class="mp-form-label">
                <label>Member Number:<br /></label>
            </div>
            <input type="text" name="mepr_user_display_name" id="mepr_user_display_name"
                class="mepr-form-input mepr-display-name"
                value="<?php echo get_user_meta($mepr_current_user->ID, "mepr_member_number", true); ?>" disabled />
            <small class="text-red"><?php echo $error_status; ?></small>
        </div>
        ...
        <div class="">
            ...
            <input type="submit" name="mepr-account-form" value="<?php _ex('Save Profile', 'ui', 'memberpress'); ?>"
                class="mepr-submit mepr-share-button btn custom-btn" />
    ...
    <!-- <div class="text-right">
        ...
        <span class="mepr-account-change-password">
            <a
                href="<?php echo $account_url.$delim.'action=newpassword'; ?>"><?php _ex('Change Password', 'ui', 'memberpress'); ?></a>
        </span>
    </div> -->
