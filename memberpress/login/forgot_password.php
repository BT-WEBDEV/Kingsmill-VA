      ...
      <div class="col-lg-8">
        ...
        <form name="mepr_forgot_password_form" id="mepr_forgot_password_form" action="" method="post">
          ...
          <div class="mp-form-row mepr_forgot_password_input">
            <label
              for="mepr_user_or_email"><?php _ex('Enter Your Username or Email Address', 'ui', 'memberpress'); ?></label>
          ...
          <div class="submit">
            <input type="submit" name="wp-submit" id="wp-submit" class="button-primary mepr-share-button btn custom-btn"
