...
<div class="mp_wrapper mp_login_form krr_memberpress">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center mb-header">
                    <h1 class="font-weight-medium">SIGN IN TO KINGSMILL</h1>
                </div>
                ...
                <form name="mepr_loginform" id="mepr_loginform" class="mepr-form" action="<?php echo $login_url; ?>"
                    method="post">
                    ...
                    <div class="mp-form-row mepr_password">
                        <div class="mepr-login-actions">
                            <a  tabindex="20"
                                href="<?php echo $forgot_password_url; ?>"><?php _ex('Forgot Password', 'ui', 'memberpress'); ?></a>
                        </div>
                        <div class="mp-form-label">
                    ...
                    <div class="submit text-center">
                        <input type="submit" name="wp-submit" id="wp-submit"  tabindex="2"
                            class="button-primary mepr-share-button btn custom-btn"
                            value="<?php _ex('Log In', 'ui', 'memberpress'); ?>" />
                        <input type="hidden" name="redirect_to" value="<?php echo esc_html($redirect_to); ?>" />
                        <input type="hidden" name="mepr_process_login_form" value="true" />
                        <input type="hidden" name="mepr_is_login_page"
                            value="<?php echo ($is_login_page)?'true':'false'; ?>" />
                    </div>
                </form>
                <!-- <div class="mp-spacer">&nbsp;</div> -->
                <!-- mp-login-form-end -->
