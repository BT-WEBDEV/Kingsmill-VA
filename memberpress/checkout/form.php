...
<div class="mp_wrapper krr_memberpress">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center mb-header">
                    <div class="font-weight-normal">ALREADY A MEMBER? <a href="/member-portal/login/"
                            class="font-weight-bold underline">SIGN IN</a></div>
                    <h1 class="font-weight-medium">SIGN UP TO KINGSMILL</h1>
                </div>
                <form class="mepr-signup-form mepr-form" method="post"
                    action="<?php echo esc_url($_SERVER['REQUEST_URI']).'#mepr_jump'; ?>" enctype="multipart/form-data"
                    novalidate>
                    ...
                    <div class="mp-form-row mepr_first_name">
                        <div class="mp-form-label">
                            <label
                                for="user_first_name<?php echo $unique_suffix; ?>"><?php _ex('First Name:', 'ui', 'memberpress'); echo ($mepr_options->require_fname_lname)?'*':''; ?></label>
                    ...
                    <div class="mp-form-row mepr_last_name">
                        <div class="mp-form-label">
                            <label
                                for="user_last_name<?php echo $unique_suffix; ?>"><?php _ex('Last Name:', 'ui', 'memberpress'); echo ($mepr_options->require_fname_lname)?'*':''; ?></label>
                    ...
                    <div class="mp-form-row mepr_coupon mepr_coupon_<?php echo $product->ID; ?> mepr-hidden">
                        <div class="mp-form-label">
                            <label
                                for="mepr_coupon_code-<?php echo $product->ID; ?>"><?php _ex('Coupon Code:', 'ui', 'memberpress'); ?></label>
                            <span class="mepr-coupon-loader mepr-hidden">
                                <img src="<?php echo includes_url('js/thickbox/loadingAnimation.gif'); ?>"
                                    title="<?php _ex('Loading icon', 'ui', 'memberpress'); ?>"
                                    alt="<?php _ex('Loading icon', 'ui', 'memberpress'); ?>" width="100" height="10" />
                            </span>
                    ...
                    <div class="mp-form-submit text-center">
                        ...
                        <input type="submit" class="mepr-submit btn custom-btn"
                        ...
                        <img src="<?php echo admin_url('images/loading.gif'); ?>"
                            ...
                            class="mepr-loading-gif" title="<?php _ex('Loading icon', 'ui', 'memberpress'); ?>" />
